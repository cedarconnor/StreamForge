...
VENDORED verbatim from https://github.com/madebyollin/taesd (MIT, (c) Ollin Boer Bohan)
on 2026-06-05. Provides the TAESD architecture; arch_variant="flux_2" matches the taef2 weights
in models/vae_tiny/taef2.safetensors. Kept as a private module so StreamForge has no runtime
dependency on cloning the upstream repo. Only edit to track upstream.
"""
import torch
